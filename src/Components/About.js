...
let myStyle = {
    ...
    <div className="accordion-item">
        ...
        TextUtils reports the number of words or characters. Thus is sutitable for writing text with word/character limit.
        </div>
        </div>
    </div>
    <div className="accordion-item">
        ...
        <div className="accordion-body" style={myStyle}>
        The word counter software works in any web browser such as Chrome, Firfox, Internet Explorer, Safari , Opera. It 
